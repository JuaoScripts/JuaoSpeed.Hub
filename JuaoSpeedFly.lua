--[[
Juao.fly v7 (Revised 5)
Criado por: [FE SCRIPTER]
Revisões:
- Adicionado handler para morte do personagem.
- Atualizado stopFlying() para ser seguro em personagens mortos.
- Corrigido typo no drag do UI para touch.
...
ScreenGui.Name = "Juao.fly"
ScreenGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
ScreenGui.ResetOnSpawn = false

--// Tooltip (Parented to ScreenGui)
...
local yPos = mainPos.Y + mainSize.Y + 5
...
--// Funções de criação de botão e row
